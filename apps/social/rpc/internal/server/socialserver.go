...
import (
	...
	"wetalk/apps/social/rpc/internal/logic"
...
// 退出群
func (s *SocialServer) GroupExit(ctx context.Context, in *social.GroupExitReq) (*social.GroupExitResp, error) {
	l := logic.NewGroupExitLogic(ctx, s.svcCtx)
	return l.GroupExit(in)
}
