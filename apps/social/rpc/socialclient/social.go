...
type (
	...
	GroupExitReq          = social.GroupExitReq
	GroupExitResp         = social.GroupExitResp
...
// 退出群
func (m *defaultSocial) GroupExit(ctx context.Context, in *GroupExitReq, opts ...grpc.CallOption) (*GroupExitResp, error) {
	client := social.NewSocialClient(m.cli.Conn())
	return client.GroupExit(ctx, in, opts...)
}
