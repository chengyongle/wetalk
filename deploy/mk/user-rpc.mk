...
# 测试环境配置
# docker的镜像发布地址
DOCKER_REPO_TEST=crpi-mnb3psxzsxgtr7db.cn-shanghai.personal.cr.aliyuncs.com/we_talk/${SERVER_NAME}-${SERVER_TYPE}
# 测试版本
VERSION_TEST=$(VERSION)
# 编译的程序名称
APP_NAME_TEST=wetalk-${SERVER_NAME}-${SERVER_TYPE}
